...
function PreviewData()
{
	cMon = frmRecEntry.FilterMonth.value;
	cYear = frmRecEntry.FilterYear.value;
	window.navigate("MonthlyReport.php?cMon=" + cMon + "&cYer=" + cYear);
}
...
<iframe id="iloader" name="iloader" width="695" height="420" border="0" src="SearchMonthlyReport.php?msg='Successfully Connection'">
