...
<body bgcolor="#C0C0C0" onload = "FillYear();">
 <iframe id="iloader" name="iloader" width="00" height="00" border="0" src="dataCaller.php?msg='Successfully Connection'">
    ...
    <td width="72%" height="76" align="right">
      <table class=bodytext border="0" cellpadding="5" cellspacing="0" width="100%">
        <tr>
          ...
          <td width="15%" bgcolor="#EEEEEE" align="right">LTA</td>
          <td width="37%" bgcolor="#EEEEEE"><input type="text" name="lta" size="20" readonly></td>
        </tr>
        <tr>
		...
		<tr>
          ...
          <td width="15%" bgcolor="#EEEEEE" align="right">M.R</td>
          <td width="37%" bgcolor="#EEEEEE"><input type="text" name="mra" size="20" readonly></td>
        </tr>
        <tr>
