...
function loadData()
{
	...
	window.frames["iloader"].document.location = "SearchDirectors_MonthlyReport.php?cMon=" + cMon + "&cYer=" + cYear;
	return true;
}
...
function PreviewData()
{
	cMon = frmRecEntry.FilterMonth.value;
	cYear = frmRecEntry.FilterYear.value;
	window.navigate("Directors_MonthlyReport.php?cMon=" + cMon + "&cYer=" + cYear);
}
...
<input name ='Filter' type = 'hidden' value="">
  ...
  <table border="1" cellspacing="0" width="265" bordercolorlight="#004848" bordercolordark="#FFFFFF" height="30">
	...
	?>
        ...
        <p align="left"><b><font color="#000000">Filter By :<select size="1" name="FilterMonth" onchange = "loadData();">
...
<select size="1" name="FilterYear" onchange = "loadData();">
...
<iframe id="iloader" name="iloader" width="695" height="420" border="0" src="SearchDirectors_MonthlyReport.php?msg='Successfully Connection'">
