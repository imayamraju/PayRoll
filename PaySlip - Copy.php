...
if($Company == 'M')
   ...
   echo "<td width='50%' valign='bottom' height='35'><img border='0' src='img/avi_logo.gif'></td>";
 else if($Company == 'I')
    echo "<td width='50%' valign='bottom' height='35'><img border='0' src='img/Mel_info.gif' width='123' height='30'></td>";
 else 
    echo "<td width='50%' valign='bottom' height='35'><img border='0' src='img/Mel_info.gif' width='123' height='30'></td>";
...
<font size="2.5">
Pay Slip for the month of <?php echo $MonthName[$FMonth]; echo " $FYear";?></font><p><BR>
<div align="center">
  <center>
          <table border="1" width="550" cellspacing="0" cellpadding="0" height="539">
            <tr>
              ...
              <td width="34%" bgcolor="#EEEEEE"><?php echo $rows[32]; ?></td>
                  </tr>
                  <tr>
              <td width="35%" align="right" bgcolor="#EEEEEE">Department :</td>
              <td width="34%" bgcolor="#EEEEEE"><?php echo $rows[31]; ?></td>
                  </tr>
                  <tr>
              ...
              <td width="23%" bgcolor="#EEEEEE"><?php echo $rows[30]; ?></td>
                  </tr>
                  <tr>
		...
		?>
              ...
              <td width="23%" bgcolor="#EEEEEE"><?php echo $rows[34];?></td>
                  </tr>
                  <tr>
            ...
            <tr>
              ...
              <td width="23%" bgcolor="#EEEEEE" ><?php echo $rows[7]; ?></td>
                  ...
                  <tr>
              <td width="24%" bgcolor="#EEEEEE" align="right">DA :</td>
              <td width="23%" bgcolor="#EEEEEE"><?php echo $rows[8]; ?></td>
                  </tr>
                  <tr>
              <td width="24%" bgcolor="#EEEEEE" align="right">HRA :</td>
              <td width="6%" bgcolor="#EEEEEE"><?php echo ($rows[9]*0.6); ?></td>
                  </tr>
                  <tr>
              <td width="24%" bgcolor="#EEEEEE" align="right">C.C.A :</td>
		...
		<?php
			...
			if($Company == 'M')
			{
 		        	echo "<tr><td width='24%' bgcolor='#EEEEEE' align='right'>Flexi.Allow :</td>";

	             		echo "<td width='6%' bgcolor='#EEEEEE' >$rows[11]</td></tr>";

			}
			else
			{
 		       	echo "<tr><td width='24%' bgcolor='#EEEEEE' align='right'>Basket Allow :</td>";
				echo "<td width='6%' bgcolor='#EEEEEE' >".($rows[9]*0.4)."</td></tr>";
				echo "<tr><td width='24%' bgcolor='#EEEEEE' align='right'>&nbsp;</td>";
				echo "<td width='6%' bgcolor='#EEEEEE' >&nbsp;</td></tr>";
			}
		...
		?>
              ...
              <td width="65%" bgcolor="#E0E0E0" colspan="2" height="126">
                <table border="0" width="100%" cellspacing="1" cellpadding="8"  class = bodytext>
                  <tr>
              <td width="7%" bgcolor="#EEEEEE" align="right">Pro. Tax :</td>
              <td width="2%" bgcolor="#EEEEEE">
                <p><?php echo $rows[13]; ?></td>
                  </tr>
                  <tr>
              ...
              <td width="2%" bgcolor="#EEEEEE" >
                <p><?php echo $rows[14] = ($rows[14] == 0) ? "NIL" : $rows[14]; ?></td>
                  ...
                  <tr>
              <td width="37%" bgcolor="#EEEEEE" align="right">IT :</td>
		...
		if($Company != 'M')
		{
                	echo("<tr><td width='37%' bgcolor='#EEEEEE' align='right'>ESI:</td>");
              		echo("<td width='32%' bgcolor='#EEEEEE' ><p>");
 			echo $rows[21] = ($rows[21] == 0) ? "N/A" : $rows[21]; 
			echo("</td></tr>");
		}
		?>
		
                  <tr>
              <td width="37%" bgcolor="#EEEEEE" align="right"><?php echo $rows[22]; ?>:</td>
              <td width="32%" bgcolor="#EEEEEE" >
		...
		if($Company == 'A' || $Company == 'I' )
		{
	          echo("<tr><td width='52%'>");
                  echo("<p align='right'>PF No :</td>");
                  echo("<center>");
        	  echo("<td width='48%'>$PFNo</td></tr>"); 
		}     
		?>
              ...
              <td width="49%" bgcolor="#E0E0E0" colspan="2" height="29">
                <table border="0" width="100%" cellspacing="0" cellpadding="4" class = header>
                  <tr>
                    ...
                    <center>
                    <td width="48%"><?php echo $rows[24]; ?></td>
                    </tr>
		<?php
		...
		{
	          echo("<tr><td width='52%'>");
                  echo("<p align='right'>PF Accumulation :</td>");
                  echo("<center>");
        	  echo("<td width='48%'> $rows[25]</td></tr>"); 
		}     
		?>
                  </table>
                </td>
...
{
	echo "<p class = header align='center' style='margin-bottom: -15'>Meltronics Infotech Pvt.Ltd,</p>";
	echo "<p class = bodytext style='margin-bottom: -15' align='center'>178,'A',Block, 4 th Block,AECS Layout, Bangalore-560 037<p>";
	echo "<p class = bodytext style='margin-bottom: -15' align='center'>Tel : 91-80-41604644 Fax : 080-28540787<p>";
	echo "<BR><BR><BR><BR><BR><BR><BR>";
	echo "<BR>";
