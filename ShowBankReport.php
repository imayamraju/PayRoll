...
function loadData()
{
	...
	window.frames["iloader"].document.location = "SearchBankDetail.php?cMon=" + cMon + "&cYer=" + cYear;
	return true;
}
function PreviewData()
{
	cMon = frmRecEntry.FilterMonth.value;
	cYear = frmRecEntry.FilterYear.value;
//	frmRecEntry.action = "SearchBankDetail.php?cMon=" + cMon + "&cYer=" + cYear;
	window.navigate("BankReport.php?cMon=" + cMon + "&cYer=" + cYear);
}
...
<input name ='Filter' type = 'hidden' value="">
  ...
  <table border="1" cellspacing="0" width="265" bordercolorlight="#004848" bordercolordark="#FFFFFF" height="30">
	...
	<tr>
        ...
        <p align="left"><b><font color="#000000">Filter By :<select size="1" name="FilterMonth" onclick = "loadData();">
...
<select size="1" name="FilterYear" onclick = "loadData();">
...
<iframe id="iloader" name="iloader" width="695" height="420" border="0" src="SearchBankDetail.php?msg='Successfully Connection'">
